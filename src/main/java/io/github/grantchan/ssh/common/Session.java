...
public abstract class Session implements IdHolder, UsernameHolder {
   ...
   *          key.
   */
  public abstract void requestKexDhInit(BigInteger e);
  ...
  public abstract void requestUserAuthRequest(String user, String service, String method);

  public abstract void requestUserAuthRequest(String user, String service, String method,
                                              String algo, PublicKey pubKey) throws IOException;

  public abstract void requestUserAuthRequest(String user, String service, String method,
                                              String algo, PublicKey pubKey, byte[] sig)
                                          throws IOException;
